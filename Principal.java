...
public class Principal extends javax.swing.JFrame {
    ...
    public Principal() {
        ...
        File file = new File("C://feijuca/banner.png");
        if(file.exists()){
            //new File("C:\\Users\\Daniel\\Documents\\Faculdade\\arquivo"+1+".txt").createNewFile();
            System.out.println("exite");
        }
        else{
            System.out.println("nao exite");
        }
    }
    ...
    private void initComponents() {
        ...
        tela = new javax.swing.JDesktopPane(){
            ...
            {
                try {
                    image = ImageIO.read(new URL("file:///C:/feijuca/banner.png"));
                }
                catch (IOException e) {
                    e.printStackTrace();
                }
